...
function escapeHtml(input) {
   ...
   * @returns {string}
   */
   function sanitizeHtml(input, allowedTags = [], maxLength = 1000) {
    if (typeof input !== 'string') return '';
   ...
   * @returns {string}
   */
   function fullySanitize(input, allowedTags = [], maxLength = 1000) {
    if (typeof input !== 'string') return '';
   ...
   */
   function validateInput(input, allowedTags = [], maxLength = 1000) {
    const errors = [];
